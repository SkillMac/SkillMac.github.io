...
```
shaderc -f ../examples/cubes/vs_cubes.sc -o ..\examples\cubes\glsl\vs_cubes.bin --platform windows -i ..\examples\cubes\ -p 120 --type vertex
shaderc -f ../examples/cubes/fs_cubes.sc -o ..\examples\cubes\glsl\fs_cubes.bin --platform windows -i ..\examples\cubes\ -p 120 --type fragment
...
```
shaderc -f ../examples/cubes/vs_cubes.sc -o ..\examples\cubes\dx11\vs_cubes.bin --platform windows -i ..\examples\cubes\ -p vs_5_0 --type vertex -O 3
shaderc -f ../examples/cubes/fs_cubes.sc -o ..\examples\cubes\dx11\fs_cubes.bin --platform windows -i ..\examples\cubes\ -p ps_5_0 --type fragment -O 3
